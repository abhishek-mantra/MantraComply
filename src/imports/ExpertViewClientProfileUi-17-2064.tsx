import svgPaths from "./svg-mom94siucl";
...
function H() {
  return (
    <div className="h-[32px] relative shrink-0 w-[206.391px]" data-name="h1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px]">Practice Modalities</p>
      </div>
    </div>
  );
}
...
function Span() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px]">Step 12 of 17</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e5e7eb] h-[4px] relative rounded-[33554400px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pr-[258.25px] relative size-full">
          <Container10 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[0] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">
        <span className="leading-[20px]">{`Therapeutic Approaches `}</span>
...
function P() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#6a7282] text-[12px] whitespace-pre-wrap">Select all therapeutic approaches you practice</p>
    </div>
  );
}
...
function Span1() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[223.656px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">CBT (Cognitive Behavioral Therapy)</p>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="col-1 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="label">
      <Input />
      <Span1 />
    </div>
  );
...
function Span2() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[218.531px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">DBT (Dialectical Behavior Therapy)</p>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="col-2 justify-self-stretch relative row-1 self-stretch shrink-0" data-name="label">
      <Input1 />
      <Span2 />
    </div>
  );
...
function Span3() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[38.953px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">EMDR</p>
    </div>
  );
}
...
function Label3() {
  return (
    <div className="col-1 justify-self-stretch relative row-2 self-stretch shrink-0" data-name="label">
      <Input2 />
      <Span3 />
    </div>
  );
...
function Span4() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[153.203px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Psychodynamic Therapy</p>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="col-2 justify-self-stretch relative row-2 self-stretch shrink-0" data-name="label">
      <Input3 />
      <Span4 />
    </div>
  );
...
function Span5() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[165.938px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Solution-Focused Therapy</p>
    </div>
  );
}
...
function Label5() {
  return (
    <div className="col-1 justify-self-stretch relative row-3 self-stretch shrink-0" data-name="label">
      <Input4 />
      <Span5 />
    </div>
  );
...
function Span6() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[176.047px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Mindfulness-Based Therapy</p>
    </div>
  );
}
...
function Label6() {
  return (
    <div className="col-2 justify-self-stretch relative row-3 self-stretch shrink-0" data-name="label">
      <Input5 />
      <Span6 />
    </div>
  );
...
function Span7() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[282.219px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Acceptance and Commitment Therapy (ACT)</p>
    </div>
  );
}
...
function Label7() {
  return (
    <div className="col-1 justify-self-stretch relative row-4 self-stretch shrink-0" data-name="label">
      <Input6 />
      <Span7 />
    </div>
  );
...
function Span8() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[163.719px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Motivational Interviewing</p>
    </div>
  );
}
...
function Label8() {
  return (
    <div className="col-2 justify-self-stretch relative row-4 self-stretch shrink-0" data-name="label">
      <Input7 />
      <Span8 />
    </div>
  );
...
function Span9() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[139.734px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Interpersonal Therapy</p>
    </div>
  );
}
...
function Label9() {
  return (
    <div className="col-1 justify-self-stretch relative row-5 self-stretch shrink-0" data-name="label">
      <Input8 />
      <Span9 />
    </div>
  );
...
function Span10() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[151.047px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Family Systems Therapy</p>
    </div>
  );
}
...
function Label10() {
  return (
    <div className="col-2 justify-self-stretch relative row-5 self-stretch shrink-0" data-name="label">
      <Input9 />
      <Span10 />
    </div>
  );
...
function Span11() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[81.469px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Play Therapy</p>
    </div>
  );
}
...
function Label11() {
  return (
    <div className="col-1 justify-self-stretch relative row-6 self-stretch shrink-0" data-name="label">
      <Input10 />
      <Span11 />
    </div>
  );
...
function Span12() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[75.25px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Art Therapy</p>
    </div>
  );
}
...
function Label12() {
  return (
    <div className="col-2 justify-self-stretch relative row-6 self-stretch shrink-0" data-name="label">
      <Input11 />
      <Span12 />
    </div>
  );
...
function Span13() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[114.078px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Narrative Therapy</p>
    </div>
  );
}
...
function Label13() {
  return (
    <div className="col-1 justify-self-stretch relative row-7 self-stretch shrink-0" data-name="label">
      <Input12 />
      <Span13 />
    </div>
  );
...
function Span14() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[110.359px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Gottman Method</p>
    </div>
  );
}
...
function Label14() {
  return (
    <div className="col-2 justify-self-stretch relative row-7 self-stretch shrink-0" data-name="label">
      <Input13 />
      <Span14 />
    </div>
  );
...
function Span15() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[112.969px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Exposure Therapy</p>
    </div>
  );
}
...
function Label15() {
  return (
    <div className="col-1 justify-self-stretch relative row-8 self-stretch shrink-0" data-name="label">
      <Input14 />
      <Span15 />
    </div>
  );
...
function Span16() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[24px] top-0 w-[159.844px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Trauma-Focused Therapy</p>
    </div>
  );
}
...
function Label16() {
  return (
    <div className="col-2 justify-self-stretch relative row-8 self-stretch shrink-0" data-name="label">
      <Input15 />
      <Span16 />
    </div>
  );
...
function Container12() {
  return (
    <div className="gap-x-[12px] gap-y-[12px] grid grid-cols-[repeat(2,minmax(0,1fr))] grid-rows-[repeat(8,minmax(0,1fr))] h-[244px] relative shrink-0 w-full" data-name="Container">
      <Label1 />
      <Label2 />
      <Label3 />
      <Label4 />
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[304px] items-start left-[33px] top-[101px] w-[878px]" data-name="Container">
      <Label />
      <P />
      <Container12 />
    </div>
...
function Container13() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[33px] pt-px top-[437px] w-[878px]" data-name="Container">
...
function Container6() {
  return (
    <div className="bg-white h-[539px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Span29() {
  return (
    <div className="h-[16px] relative shrink-0 w-[103.203px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px]">Practice Modalities</p>
      </div>
    </div>
  );
}
