import svgPaths from "./svg-f9t7qk07zf";
...
function H() {
  return (
    <div className="h-[32px] relative shrink-0 w-[168.578px]" data-name="h1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px]">Insurance Plans</p>
      </div>
    </div>
  );
}
...
function Span() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px]">Step 17 of 17</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="bg-[#e5e7eb] content-stretch flex flex-col h-[4px] items-start overflow-clip relative rounded-[33554400px] shrink-0 w-full" data-name="Container">
      <Container10 />
    </div>
  );
}
...
function P() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">{`Select which insurance carriers you'd like to credential with and review the reimbursement rates.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[0] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">
        <span className="leading-[20px]">{`Desired Insurance Carriers `}</span>
...
function Container13() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[220px] items-start relative shrink-0 w-full" data-name="Container">
      <Label />
      <Container14 />
    </div>
  );
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[294px] items-start left-[33px] top-[101px] w-[878px]" data-name="Container">
      <Container12 />
      <Container13 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#3b82f6] h-[44px] relative rounded-[10px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0 w-[203.328px]" data-name="button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[102.5px] not-italic text-[16px] text-center text-white top-[8px]">Submit Application</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[33px] pt-px top-[427px] w-[878px]" data-name="Container">
...
function Container6() {
  return (
    <div className="bg-white h-[529px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Span25() {
  return (
    <div className="h-[16px] relative shrink-0 w-[84.297px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px]">Insurance Plans</p>
      </div>
    </div>
  );
}
