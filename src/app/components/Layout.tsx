...
import { FileText, ListTodo, Shield, FolderOpen, Menu } from "lucide-react";
...
export function Layout() {
  ...
  const navItems = [
    { name: "My Profile", path: "/", icon: FileText },
    { name: "Tasks", path: "/tasks", icon: ListTodo },
    { name: "Active Insurance", path: "/active-insurance", icon: Shield },
