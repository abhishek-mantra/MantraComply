import svgPaths from "./svg-rntohx6o62";
...
function Container4() {
  return <div className="h-[1225px] shrink-0 w-[256px]" data-name="Container" />;
}

function H() {
  return (
    <div className="h-[32px] relative shrink-0 w-[155.188px]" data-name="h1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px]">Release Forms</p>
      </div>
    </div>
  );
}
...
function Span() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px]">Step 16 of 17</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e5e7eb] h-[4px] relative rounded-[33554400px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pr-[51.656px] relative size-full">
          <Container10 />
        </div>
      </div>
    </div>
...
function P() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">⚠️ Please review and sign the following agreements</p>
    </div>
  );
}
...
function P1() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#4a5565] text-[12px] whitespace-pre-wrap">These documents are required to proceed with credentialing.</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="bg-[#fefce8] h-[78px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function H2() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[17px] top-[17px] w-[844px]" data-name="h3">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-h-px min-w-px not-italic relative text-[#101828] text-[14px] whitespace-pre-wrap">Business Associate Agreement (BAA)</p>
    </div>
  );
}
...
function P2() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#364153] text-[12px]">{`This Business Associate Agreement ("Agreement") is entered into between MantraCare ("Covered Entity") and the Provider ("Business Associate").`}</p>
    </div>
  );
}
...
function P3() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] text-[12px] top-0 w-[814px] whitespace-pre-wrap">
        <span className="leading-[16px]">1. Purpose:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` This Agreement sets forth the terms under which Business Associate may use and disclose Protected Health Information (PHI) in the course of performing services for Covered Entity.`}</span>
      </p>
    </div>
  );
}
...
function P4() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] text-[12px] top-0 w-[771px] whitespace-pre-wrap">
        <span className="leading-[16px]">2. Permitted Uses and Disclosures:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` Business Associate may use and disclose PHI only as necessary to perform the services outlined in the service agreement.`}</span>
      </p>
    </div>
  );
}
...
function P5() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[0] min-h-px min-w-px not-italic relative text-[#364153] text-[0px] text-[12px] whitespace-pre-wrap">
        <span className="leading-[16px]">3. Safeguards:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` Business Associate agrees to implement appropriate safeguards to prevent unauthorized use or disclosure of PHI.`}</span>
      </p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute bg-[#f9fafb] content-stretch flex flex-col gap-[8px] h-[144px] items-start left-[17px] overflow-clip pt-[12px] px-[12px] rounded-[4px] top-[45px] w-[844px]" data-name="Container">
      <P2 />
      <P3 />
      <P4 />
      <P5 />
...
function Label() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Digital Signature</p>
    </div>
  );
}
    ...
    <div className="h-[42px] relative rounded-[10px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(10,10,10,0.5)]">Type your full name to sign</p>
        </div>
      </div>
...
function P6() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#6a7282] text-[12px] whitespace-pre-wrap">By typing your name, you agree to the terms of the Business Associate Agreement.</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[111px] items-start left-[17px] pt-[17px] top-[205px] w-[844px]" data-name="Container">
...
function Input1() {
  return <div className="absolute left-0 size-[16px] top-[2px]" data-name="input" />;
}

function Span1() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[28px] top-0 w-[375.047px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">I have read and agree to the Business Associate Agreement</p>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="absolute h-[20px] left-[17px] top-[332px] w-[844px]" data-name="label">
      <Input1 />
      <Span1 />
    </div>
  );
...
function Container13() {
  return (
    <div className="bg-white h-[369px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function H3() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[17px] top-[17px] w-[844px]" data-name="h3">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] min-h-px min-w-px not-italic relative text-[#101828] text-[14px] whitespace-pre-wrap">Provider Agreement</p>
    </div>
  );
}
...
function P7() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#364153] text-[12px] whitespace-pre-wrap">{`This Provider Agreement ("Agreement") is entered into between MantraCare and the Provider.`}</p>
    </div>
  );
}
...
function P8() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] text-[12px] top-0 w-[813px] whitespace-pre-wrap">
        <span className="leading-[16px]">1. Services:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` Provider agrees to provide mental health services to clients referred through the MantraCare platform in accordance with applicable laws and professional standards.`}</span>
      </p>
    </div>
  );
}
...
function P9() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="p">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[0] left-0 not-italic text-[#364153] text-[0px] text-[12px] top-0 w-[768px] whitespace-pre-wrap">
        <span className="leading-[16px]">2. Credentialing:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` Provider authorizes MantraCare to submit credentialing applications on their behalf to insurance companies and managed care organizations.`}</span>
      </p>
    </div>
  );
}
...
function P10() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[0] not-italic relative shrink-0 text-[#364153] text-[0px] text-[12px]">
        <span className="leading-[16px]">3. Compliance:</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[16px]">{` Provider agrees to maintain all required licenses, certifications, and insurance coverage throughout the term of this agreement.`}</span>
      </p>
    </div>
  );
}
...
function P11() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#6a7282] text-[12px] whitespace-pre-wrap">By typing your name, you agree to the terms of the Provider Agreement.</p>
    </div>
  );
}
...
function Span2() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-[28px] top-0 w-[310.828px]" data-name="span">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">I have read and agree to the Provider Agreement</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[856px] items-start left-[33px] top-[101px] w-[878px]" data-name="Container">
      <Container12 />
      <Container13 />
      <Container16 />
    </div>
...
function Container19() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[33px] pt-px top-[989px] w-[878px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-solid border-t inset-0 pointer-events-none" />
      <Button1 />
      <Button2 />
    </div>
...
function Container6() {
  return (
    <div className="bg-white h-[1091px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Container5() {
  return (
    <div className="flex-[1_0_0] h-[1225px] min-h-px min-w-px relative" data-name="Container">
...
function Container3() {
  return (
    <div className="absolute content-stretch flex gap-[32px] h-[1289px] items-start left-[312.5px] pt-[32px] px-[24px] top-[73px] w-[1280px]" data-name="Container">
      <Container4 />
      <Container5 />
    </div>
  );
...
function Div() {
  return (
    <div className="bg-[#f5f5f7] h-[1362px] relative shrink-0 w-full" data-name="div">
      <Container />
      <Container3 />
    </div>
  );
...
function Span19() {
  return (
    <div className="h-[16px] relative shrink-0 w-[77.594px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px]">Release Forms</p>
      </div>
    </div>
  );
}
