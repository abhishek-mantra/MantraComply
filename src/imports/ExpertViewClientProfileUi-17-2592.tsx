import svgPaths from "./svg-6l34zapapf";
...
function H() {
  return (
    <div className="h-[32px] relative shrink-0 w-[161.719px]" data-name="h1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px]">Current Clients</p>
      </div>
    </div>
  );
}
...
function Span() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px]">Step 15 of 17</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e5e7eb] h-[4px] relative rounded-[33554400px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pr-[103.297px] relative size-full">
          <Container10 />
        </div>
      </div>
    </div>
...
function P() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">List any current clients who may need benefit verification for insurance credentialing purposes.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Number of Current Active Clients</p>
    </div>
  );
}
    ...
    <div className="h-[42px] relative rounded-[10px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(10,10,10,0.5)]">0</p>
        </div>
      </div>
...
function Label1() {
  return (
    <div className="absolute content-stretch flex h-[20px] items-start left-0 top-0 w-[878px]" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Client Names (Optional)</p>
    </div>
  );
}
...
function Textarea() {
  return (
    <div className="absolute h-[162px] left-0 rounded-[10px] top-[26px] w-[878px]" data-name="textarea">
      <div className="content-stretch flex items-start overflow-clip px-[12px] py-[8px] relative rounded-[inherit] size-full">
        <div className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[16px] text-[rgba(10,10,10,0.5)] whitespace-nowrap">
          <p className="mb-0">List client names, one per line</p>
...
function P1() {
  return (
    <div className="absolute content-stretch flex h-[16px] items-start left-0 top-[198px] w-[878px]" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px not-italic relative text-[#6a7282] text-[12px] whitespace-pre-wrap">This information is kept confidential and used only for verification purposes.</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[376px] items-start left-[33px] top-[101px] w-[878px]" data-name="Container">
      <Container12 />
      <Container13 />
      <Container14 />
    </div>
...
function Container15() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[33px] pt-px top-[509px] w-[878px]" data-name="Container">
...
function Container6() {
  return (
    <div className="bg-white h-[611px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Span16() {
  return (
    <div className="h-[16px] relative shrink-0 w-[80.859px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px]">Current Clients</p>
      </div>
    </div>
  );
}
