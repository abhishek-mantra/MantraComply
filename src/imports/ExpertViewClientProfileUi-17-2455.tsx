import svgPaths from "./svg-11rwr7p26u";
...
function Container4() {
  return <div className="h-[919px] shrink-0 w-[256px]" data-name="Container" />;
}

function H() {
  return (
    <div className="h-[32px] relative shrink-0 w-[257.063px]" data-name="h1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px]">Current Insurance Plans</p>
      </div>
    </div>
  );
}
...
function Span() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.578px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#6a7282] text-[14px]">Step 14 of 17</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#e5e7eb] h-[4px] relative rounded-[33554400px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pr-[154.953px] relative size-full">
          <Container10 />
        </div>
      </div>
    </div>
...
function P() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="p">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Please indicate which insurance panels you are currently credentialed with (if any).</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="bg-[#eff6ff] h-[54px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
...
function Label() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Current Insurance Panels</p>
    </div>
  );
}
...
function Span1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[37.375px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Aetna</p>
      </div>
    </div>
  );
}
...
function Span2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[36.266px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Cigna</p>
      </div>
    </div>
  );
}
...
function Span3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[110.813px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">UnitedHealthcare</p>
      </div>
    </div>
  );
}
...
function Span4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[140.141px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Blue Cross Blue Shield</p>
      </div>
    </div>
  );
}
...
function Span5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[53.656px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Humana</p>
      </div>
    </div>
  );
}
...
function Span6() {
  return (
    <div className="h-[20px] relative shrink-0 w-[81.453px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Oscar Health</p>
      </div>
    </div>
  );
}
...
function Span7() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.625px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Anthem</p>
      </div>
    </div>
  );
}
...
function Span8() {
  return (
    <div className="h-[20px] relative shrink-0 w-[58.859px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Medicare</p>
      </div>
    </div>
  );
}
...
function Span9() {
  return (
    <div className="h-[20px] relative shrink-0 w-[58.469px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Medicaid</p>
      </div>
    </div>
  );
}
...
function Span10() {
  return (
    <div className="h-[20px] relative shrink-0 w-[44.656px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Optum</p>
      </div>
    </div>
  );
}
...
function Span11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[58.922px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Magellan</p>
      </div>
    </div>
  );
}
...
function Span12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[41.813px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Tricare</p>
      </div>
    </div>
  );
}
...
function Span13() {
  return (
    <div className="h-[20px] relative shrink-0 w-[118.25px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px]">Kaiser Permanente</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[356px] items-start relative shrink-0 w-full" data-name="Container">
      <Label1 />
      <Label2 />
      <Label3 />
      <Label4 />
...
function Container13() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] h-[388px] items-start relative shrink-0 w-full" data-name="Container">
      <Label />
      <Container14 />
    </div>
  );
...
function Label14() {
  return (
    <div className="content-stretch flex h-[20px] items-start relative shrink-0 w-full" data-name="label">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[#364153] text-[14px] whitespace-pre-wrap">Other Insurance (not listed above)</p>
    </div>
  );
}
    ...
    <div className="h-[42px] relative rounded-[10px] shrink-0 w-full" data-name="input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-[rgba(10,10,10,0.5)]">Enter insurance plan name</p>
        </div>
      </div>
...
function Container11() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[550px] items-start left-[33px] top-[101px] w-[878px]" data-name="Container">
      <Container12 />
      <Container13 />
      <Container15 />
    </div>
...
function Container16() {
  return (
    <div className="absolute content-stretch flex h-[69px] items-center justify-between left-[33px] pt-px top-[683px] w-[878px]" data-name="Container">
...
function Container6() {
  return (
    <div className="bg-white h-[785px] relative rounded-[14px] shrink-0 w-full" data-name="Container">
...
function Container5() {
  return (
    <div className="flex-[1_0_0] h-[919px] min-h-px min-w-px relative" data-name="Container">
...
function Container3() {
  return (
    <div className="absolute content-stretch flex gap-[32px] h-[983px] items-start left-[312.5px] pt-[32px] px-[24px] top-[73px] w-[1280px]" data-name="Container">
      <Container4 />
      <Container5 />
    </div>
  );
...
function Div() {
  return (
    <div className="bg-[#f5f5f7] h-[1056px] relative shrink-0 w-full" data-name="div">
      <Container />
      <Container3 />
    </div>
  );
...
function Span28() {
  return (
    <div className="h-[16px] relative shrink-0 w-[128.531px]" data-name="span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px]">Current Insurance Plans</p>
      </div>
    </div>
  );
}
